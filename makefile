ASM=nasm
FILES= ./build/kernel.asm.o ./build/kernel.o ./build/gdt/gdt.o ./build/task/tss.asm.o ./build/gdt/gdt.asm.o ./build/memory/paging/paging.asm.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/disk/disk.o ./build/memory/paging/paging.o ./build/memory/memory.o ./build/memory/heap/kheap.o ./build/memory/heap/heap.o ./build/io/io.asm.o ./build/fs/pparser.o ./build/string/string.o ./build/disk/streamer.o ./build/fs/file.o ./build/fs/fat/fat16.o ./build/task/task.o
INCLUDES = -I./src
